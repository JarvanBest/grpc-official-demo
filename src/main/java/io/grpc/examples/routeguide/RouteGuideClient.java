...
/**
 * 描述：
 * Created by zjw on 2021/5/25 17:06
 */
public class RouteGuideClient {

    private final ManagedChannel channel;//grpc信道,需要指定端口和地址
    private final RouteGuideGrpc.RouteGuideStub asyncStub;//非阻塞存根/异步
    private final RouteGuideGrpc.RouteGuideBlockingStub blockingStub;//阻塞存根/同步
